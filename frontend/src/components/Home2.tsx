import { DollarSign, Zap,CheckCircle, ThumbsUp } from 'lucide-react'
...
export function Home2() {
  ...
  return (
    <div className="w-full">
      ...
      {/* Features Section */}
      <div className="px-4 mx-auto my-12 max-w-7xl sm:px-6 md:my-24 lg:my-32 lg:px-8">
      ...
      <section className="px-2 py-10 mx-auto max-w-7xl bg-gray-50 md:px-0">
        <div>
      ...
      <div className='flex flex-col items-center justify-center gap-10 my-16'>
            ...
            <div className="flex justify-center mt-10 overflow-hidden flex-nowrap">
      ...
      <div className="px-2 py-2 mx-auto my-12 max-w-7xl md:my-24 lg:my-32 lg:px-0">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
          <div className="w-full md:w-2/3 lg:w-1/2">
            <h2 className="text-3xl font-bold text-black">Let's dive towards your Journey</h2>
            <p className="mt-4 mb-10 font-mono font-semibold text-gray-600 pr-14">
            ...
            <div>
              <button
                type="button"
                className="w-24 px-3 py-2 font-mono font-bold text-white rounded-md shadow-sm bg-cyan-600 text-md hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
          ...
          <div className="w-full mt-10 md:w-2/3 lg:mt-0 lg:w-1/2">
            <img
